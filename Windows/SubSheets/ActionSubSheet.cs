...
namespace ActionTimelineReplacement.Windows.SubSheets
{
    public class ActionSubSheet
    {
        ...
        public static void Draw(string mainkey, ref Configuration.ReplacementSet _activeSet, ref Dictionary<string, float>  _AllItemWidths,ref string _searchAction)
        {
