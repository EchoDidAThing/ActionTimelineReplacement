...
#region Main
public class MountTransientsMain
{
    const string type = "MountTransients";
    const string typename = "Mount Transient";
    const string typenameplural = "Mount Transients";
    ...
    public static void Draw(string mainkey, ref Configuration.ReplacementSet _activeSet, ref string search) {
        ...
        Dictionary<uint, MountTransientsConfig> Writer = _activeSet.MountTransientsWriter;
        var GetName = MountTransientsManager.GetName;
        var CreateEntry = MountTransientsConfig.CreateEntry;
        ...
        if (subList) {
            ...
            {
                var old = MountTransientsManager.GetOriginal(key);
