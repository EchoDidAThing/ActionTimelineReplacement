...
#region Main
public class TraitTransientsMain
{
    const string type = "TraitTransients";
    const string typename = "Trait Transient";
    const string typenameplural = "Trait Transients";
    ...
    public static void Draw(string mainkey, ref Configuration.ReplacementSet _activeSet, ref string search) {
        ...
        Dictionary<uint, TraitTransientsConfig> Writer = _activeSet.TraitTransientsWriter;
        var GetName = TraitTransientsManager.GetName;
        var CreateEntry = TraitTransientsConfig.CreateEntry;
        ...
        if (subList) {
            ...
            {
                var old = TraitTransientsManager.GetOriginal(key);
