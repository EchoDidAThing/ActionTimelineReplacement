...
#region Main
public class OrnamentTransientsMain
{
    const string type = "OrnamentTransients";
    const string typename = "Ornament Transient";
    const string typenameplural = "Ornament Transients";
    ...
    public static void Draw(string mainkey, ref Configuration.ReplacementSet _activeSet, ref string search) {
        ...
        Dictionary<uint, OrnamentTransientsConfig> Writer = _activeSet.OrnamentTransientsWriter;
        var GetName = OrnamentTransientsManager.GetName;
        var CreateEntry = OrnamentTransientsConfig.CreateEntry;
        ...
        if (subList) {
            ...
            {
                var old = OrnamentTransientsManager.GetOriginal(key);
