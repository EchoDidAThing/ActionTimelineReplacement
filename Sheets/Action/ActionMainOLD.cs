    ...
    public static void Draw(string mainkey, ref Configuration.ReplacementSet _activeSet, ref string search)
    {
        ...
        if (subList)
        {
            ...
            { 
                ...
                //UiGlobals.DrawUShort("Cast", type, key, _activeSet.ActionWriter[key].Enabled, ref replace.CastVfx, DefaultValues.CastVfx, true, ["ActionCastVFX_Index","ActionCastVFX-VFX_Path"]);
